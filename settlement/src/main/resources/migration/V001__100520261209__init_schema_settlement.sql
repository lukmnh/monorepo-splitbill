...
CREATE INDEX IF NOT EXISTS idx_settlement_group_id       ON settlement_records(group_id);
CREATE INDEX IF NOT EXISTS idx_settlement_created_at  ON settlement_records(created_at);
